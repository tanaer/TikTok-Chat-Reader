...
const ADMIN_SETTINGS_GROUPS = [
    {
        ...
        fields: [
            ...
            { key: 'gift_room_limit', label: '注册赠送房间数', type: 'number', hint: '新用户注册后赠送的房间额度。', tooltip: '控制新用户注册成功后默认获得的房间数量额度。通常与赠送时长、可打开房间数一起组成新手体验包。' },
            { key: 'gift_open_room_limit', label: '赠送可打开房间数', type: 'number', hint: '赠送期间可同时开启的房间数。', tooltip: '区别于总房间额度，这里限制赠送期内用户能同时打开多少个房间。适合控制新用户资源占用，避免一次性开启过多监控。' },
