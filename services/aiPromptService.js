...
const PROMPT_TEMPLATES = {
    ...
    customer_analysis_review: {
        ...
        defaultContent: [
            ...
            '',
            '字段解释偏好：',
            '1. valueLevelCurrentRoom 优先参考 room_lrfm.tier、abc_current_room.tier、clv_current_room_30d.value。',
            '2. valueLevelGlobal 优先参考 platform_lrfm.tier。',
            '3. loyaltyAssessment 优先参考 currentRoomValueShare30d、currentRoomInactiveDays、platformInactiveDays。',
            '4. diversionRiskAssessment 优先参考 otherRoomsValueShare30d、otherRoomGrowthFlag。',
            '5. conversionStage 优先参考 gift_value、danmu_count、onlyWatchNoGiftFlag、onlyGiftNoChatFlag。',
            '',
            '输出要求：',
            ...
            '- outreachScript 要偏主播或场控可直接说的话，语气自然，不要像报告。',
            ...
            '- 如果当前房间价值低但平台价值高，要明确区分“平台有价值”和“本房未拿住”这两个结论。',
            '',
            '结构化客户上下文如下：',
            '{{customerContextJson}}',
            '',
