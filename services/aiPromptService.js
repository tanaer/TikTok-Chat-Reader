...
const PROMPT_TEMPLATES = {
    ...
    session_recap_review: {
        ...
        defaultContent: [
            ...
            '7. 涉及时间表达时，优先沿用输入里的“开播后XX:XX-开播后XX:XX”相对时间范围，不要改写成北京时间或具体日期时间。',
            '',
            ...
            '- nickname、uniqueId、totalGiftValue、giftCount、enterTime、leaveTime 等字段优先沿用输入，不要编造；如果输入给的是开播后时间范围，就继续沿用相对时间表达。',
